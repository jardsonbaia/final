...
wget https://github.com/eduardaviriato/final/blob/master/linguagem.tar.gz
tar -zxf linguagem.tar.gz
rm linguagem.tar.gz
sudo mv linguagem /var/www/html/wordpress/wp-content/languages
